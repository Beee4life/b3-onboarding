...
You can customize every aspect of the onboarding process, such as control the look and feel of (almost) every email sent out by Wordpress.
...
<a name="changelog"></a>
### Changelog
For changelogs, see [this link](https://b3onboarding.berryplasman.com/changelog/).
