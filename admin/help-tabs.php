<?php
    ...
    function b3_help_tabs( $screen ) {
        ...
        if ( 'toplevel_page_b3-onboarding' === $screen->id ) {
            ...
            echo sprintf( '<p>%s</p>', sprintf( '<a href="%1$s">%2$s</a>', esc_url( B3OB_PLUGIN_SITE ) . '?utm_source=' . $_SERVER[ 'SERVER_NAME' ] . '&utm_medium=onboarding_admin&utm_campaign=free_promo', esc_html__( 'Official site', 'b3-onboarding' ) ) );
