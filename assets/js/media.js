...
jQuery(document).ready(function($){
    ...
    $(document.body).on('click.B3OpenMediaManager', '.b3-open-media', function(e){
         ...
         */
        b3_media_frame = wp.media.frames.b3_media_frame = wp.media({
            /**
         ...
         */
        b3_media_frame.on('select', function(){
            // Grab our attachment selection and construct a JSON representation of the model.
            var media_attachment = b3_media_frame.state().get('selection').first().toJSON();

            // Send the attachment URL to our custom input field via jQuery.
            $('#b3_loginpage_logo').val(media_attachment.url);
        });
