<?php
    ...
    function b3_default_account_activated_message() {
        ...
        if ( true != get_option( 'b3_activate_custom_passwords' ) ) {
            ...
            $message .= sprintf( esc_html__( 'you have confirmed your email address and can now %s.', 'b3-onboarding' ), sprintf( '<a href="%s">%s</a>', b3_get_login_url(), esc_html__( 'here', 'b3-onboarding' ) ) );
        }
