<?php
     ...
     * @since 1.0.0
     */
    $account_activated_email_subject = get_site_option( 'b3_account_activated_subject', false );
    $account_activated_email_message = get_site_option( 'b3_account_activated_message', false );
?>
