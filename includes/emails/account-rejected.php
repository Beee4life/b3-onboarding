...
<table class="b3_table b3_table--emails">
    ...
    <tr>
        ...
        <td>
            <label>
                <input name="b3_disable_delete_user_email" type="checkbox" value="1" <?php checked($disable_admin_notification); ?>/> <?php esc_html_e( "Don't send email to user when deleting or rejecting", 'b3-onboarding' ); ?>
            </label>
        </td>
    </tr>
    <tr>
