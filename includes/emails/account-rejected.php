<?php
     ...
     * @since 1.0.0
     */
    $disable_admin_notification = get_site_option( 'b3_disable_delete_user_email', false );
    $reject_user_email_subject  = get_site_option( 'b3_account_rejected_subject', false );
    $reject_user_email_message  = get_site_option( 'b3_account_rejected_message', false );
?>
