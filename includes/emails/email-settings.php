<?php
     ...
     * @since 1.0.0
     */
    $notification_sender_email = get_site_option( 'b3_notification_sender_email', false );
    $notification_sender_name  = get_site_option( 'b3_notification_sender_name', false );
?>
