...
<table class="b3_table b3_table--emails">
    ...
    <tr>
        ...
        <td>
            ...
            <br /><br />
            <textarea id="b3__input--forgot-password-message" name="b3_forgot_password_message" placeholder="<?php echo esc_attr( b3_default_forgot_password_message() ); ?>" rows="6"><?php echo stripslashes( $forgot_password_message ); ?></textarea>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
