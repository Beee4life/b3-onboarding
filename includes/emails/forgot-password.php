...
<table class="b3__table b3__table--emails" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td>
            ...
            <br /><br />
            <?php esc_html_e( "Available variables are:", "b3-onboarding" ); ?> %salutation%, %email_styling%, %home_url%, %site_url%, %site_name%
            <br /><br />
            <textarea id="b3__input--forgot-password-message" name="b3_forgot_password_message" placeholder="<?php echo b3_default_forgot_password_template(); ?>" rows="4"><?php if ( $forgot_password_message ) { echo $forgot_password_message; } ?></textarea>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
