<?php
     ...
     * @since 2.6.0
     */
    $activated_wpmu_user_subject = get_option( 'xb3_email_subject', false );
    $activated_wpmu_user_message = get_option( 'xb3_email_activation_message', false );
...
<table class="b3_table b3_table--emails">
    ...
    <tr>
        ...
        <td>
            <input class="" id="b3__input--new-user-subject" name="b3_input_new_wpmu_user_subject" type="text" placeholder="<?php echo $placeholder_subject; ?>" value="<?php echo esc_attr( $activated_wpmu_user_subject ); ?>" />
        </td>
    </tr>
    <tr>
        <th class="align-top">
        ...
        <td>
            <textarea id="b3__input--new-user-message" name="b3_input_new_wpmu_user_message" placeholder="<?php echo $placeholder_message; ?>" rows="6"><?php echo stripslashes( $activated_wpmu_user_message ); ?></textarea>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
