<?php
     ...
     * @since 2.6.0
     */
    $activated_wpmu_user_subject = get_option( 'b3_activated_wpmu_user_subject', false );
    $activated_wpmu_user_message = get_option( 'b3_activated_wpmu_user_message', false );
