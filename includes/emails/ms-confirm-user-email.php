...
<table class="b3_table b3_table--emails">
    ...
    <tr>
        ...
        <td>
            <textarea id="b3__input--confirm-wpmu-user-message" name="b3_confirm_wpmu_user_message" placeholder="<?php echo esc_attr( $placeholder_message ); ?>" rows="6"><?php echo wp_kses_post( $new_wpmu_user_message ); ?></textarea>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
