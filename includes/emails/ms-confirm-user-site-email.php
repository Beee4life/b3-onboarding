<?php
    ...
    $placeholder_subject   = b3_get_default_subject_new_wpmu_user_blog();
    $placeholder_subject   = strtr( $placeholder_subject, b3_get_replacement_vars( 'subject' ) );
    $placeholder_message   = esc_attr( b3_get_default_message_new_wpmu_user_blog() );
?>
<table class="b3_table b3_table--emails">
    ...
    <tr>
        ...
        <td>
            <textarea id="b3__input--confirm-wpmu-user-site-message" name="b3_activate_wpmu_user_site_message" placeholder="<?php echo esc_attr( $placeholder_message ); ?>" rows="6"><?php echo esc_textarea( $new_wpmu_user_message ); ?></textarea>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
