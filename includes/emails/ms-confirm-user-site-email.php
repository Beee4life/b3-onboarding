<?php
     ...
     * @since 2.6.0
     */
    $new_wpmu_user_subject = get_site_option( 'b3_confirm_wpmu_user_site_subject', false );
    $new_wpmu_user_message = get_site_option( 'b3_confirm_wpmu_user_site_message', false );
...
<table class="b3_table b3_table--emails">
    ...
    <tr>
        ...
        <td>
            <input class="" id="b3__input--confirm-wpmu-user-site-subject" name="b3_confirm_wpmu_user_site_subject" type="text" placeholder="<?php echo $placeholder_subject; ?>" value="<?php echo esc_attr( $new_wpmu_user_subject ); ?>" />
        </td>
    </tr>
    <tr>
        <th class="align-top">
        ...
        <td>
            <textarea id="b3__input--confirm-wpmu-user-site-message" name="b3_confirm_wpmu_user_site_message" placeholder="<?php echo $placeholder_message; ?>" rows="6"><?php echo stripslashes( $new_wpmu_user_message ); ?></textarea>
        </td>
    </tr>
    <tr>
        <th>&nbsp;</th>
