<?php
    ...
    $new_wpmu_user_subject = get_site_option( 'b3_welcome_mu_user_subject' );
    $new_wpmu_user_message = get_site_option( 'b3_welcome_mu_user_message' );
    $placeholder_subject   = esc_attr( b3_default_welcome_mu_user_subject() );
    $placeholder_message   = esc_attr( b3_default_welcome_mu_user_message() );
?>
