<?php
    ...
    function b3_account_approved_message_example( $message, $user_email = '' ) {
        return 'Filter message - <a href="#">Account</a> approved';
    }
    add_filter( 'b3_account_approved_message', 'b3_account_approved_message_example', 10, 2 );
    ...
    function b3_account_activated_message_user_example( $message, $user_email = '' ) {
        return 'Filter message - <a href="#">Account</a> activated';
    }
    add_filter( 'b3_account_activated_message_user', 'b3_account_activated_message_user_example', 10, 2 );
