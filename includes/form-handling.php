        ...
        if ( 'POST' == $_SERVER[ 'REQUEST_METHOD' ] && isset( $_POST[ 'b3_emails_nonce' ] ) ) {
            if ( ! wp_verify_nonce( $_POST[ 'b3_emails_nonce' ], 'b3-emails-nonce' ) ) {
                ...
                if ( isset( $sender_email ) ) {
                    update_option( 'b3_notification_sender_email', $sender_email );
                } else {
                ...
                if ( isset( $_POST[ 'b3_notification_sender_name' ] ) && ! empty( $_POST[ 'b3_notification_sender_name' ] ) ) {
                    update_option( 'b3_notification_sender_name', $_POST[ 'b3_notification_sender_name' ] );
                } else {
                    delete_option( 'b3_notification_sender_email' );
                }
                ...
                if ( isset( $_POST[ 'b3_email_styling' ] ) && ! empty( $_POST[ 'b3_email_styling' ] ) ) {
                    update_option( 'b3_email_styling', stripslashes( $_POST[ 'b3_email_styling' ] ) );
                } else {
                    delete_option( 'b3_email_styling' );
                }

                if ( isset( $_POST[ 'b3_welcome_new_user_subject' ] ) && ! empty( $_POST[ 'b3_welcome_new_user_subject' ] ) ) {
                    update_option( 'b3_welcome_new_user_subject', stripslashes( $_POST[ 'b3_welcome_new_user_subject' ] ) );
                } else {
                ...
                if ( in_array( get_option( 'b3_registration_type' ), array( 'open', 'email_activation' ) ) ) {
                    ...
                    if ( isset( $_POST[ 'b3_new_user_notification_addresses' ] ) && ! empty( $_POST[ 'b3_new_user_notification_addresses' ] ) ) {
                        ...
                        if ( isset( $emails ) ) {
                            ...
                            update_option( 'b3_new_user_notification_addresses', $email_string );
                        }
                    } else {
                ...
                if ( 'request_access' == get_option( 'b3_registration_type' ) ) {
                    ...
                    update_option( 'b3_request_access_message_user', htmlspecialchars( $_POST[ 'b3_request_access_message_user' ] ) );
                    update_option( 'b3_request_access_notification_addresses', $_POST[ 'b3_request_access_notification_addresses' ] );
                    update_option( 'b3_request_access_subject_admin', $_POST[ 'b3_request_access_subject_admin' ] );
                    update_option( 'b3_request_access_subject_user', $_POST[ 'b3_request_access_subject_user' ] );
                    update_option( 'b3_account_rejected_message', htmlspecialchars( $_POST[ 'b3_account_rejected_message' ], ENT_QUOTES ) );
                    update_option( 'b3_account_rejected_subject', $_POST[ 'b3_account_rejected_subject' ] );

                    if ( isset( $_POST[ 'b3_disable_delete_user_email' ] ) && 1 == $_POST[ 'b3_disable_delete_user_email' ] ) {
                        update_option( 'b3_disable_delete_user_email', 1 );
                    } else {
                ...
                if ( is_multisite() ) {
                    if ( isset( $_POST[ 'b3_confirm_wpmu_user_subject' ] ) && ! empty( $_POST[ 'b3_confirm_wpmu_user_subject' ] ) ) {
                        update_option( 'b3_confirm_wpmu_user_subject', stripslashes( $_POST[ 'b3_confirm_wpmu_user_subject' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_confirm_wpmu_user_message' ] ) && ! empty( $_POST[ 'b3_confirm_wpmu_user_message' ] ) ) {
                        update_option( 'b3_confirm_wpmu_user_message', htmlspecialchars( $_POST[ 'b3_confirm_wpmu_user_message' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_activated_wpmu_user_subject' ] ) && ! empty( $_POST[ 'b3_activated_wpmu_user_subject' ] ) ) {
                        update_option( 'b3_activated_wpmu_user_subject', stripslashes( $_POST[ 'b3_activated_wpmu_user_subject' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_activated_wpmu_user_message' ] ) && ! empty( $_POST[ 'b3_activated_wpmu_user_message' ] ) ) {
                        update_option( 'b3_activated_wpmu_user_message', htmlspecialchars( $_POST[ 'b3_activated_wpmu_user_message' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_activate_wpmu_user_site_message' ] ) && ! empty( $_POST[ 'b3_activate_wpmu_user_site_message' ] ) ) {
                        update_option( 'b3_activate_wpmu_user_site_message', htmlspecialchars( $_POST[ 'b3_activate_wpmu_user_site_message' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_activated_wpmu_user_site_subject' ] ) && ! empty( $_POST[ 'b3_activated_wpmu_user_site_subject' ] ) ) {
                        update_option( 'b3_activated_wpmu_user_site_subject', stripslashes( $_POST[ 'b3_activated_wpmu_user_site_subject' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_activated_wpmu_user_site_message' ] ) && ! empty( $_POST[ 'b3_activated_wpmu_user_site_message' ] ) ) {
                        update_option( 'b3_activated_wpmu_user_site_message', htmlspecialchars( $_POST[ 'b3_activated_wpmu_user_site_message' ] ) );
                    } else {
                    ...
                    if ( isset( $_POST[ 'b3_new_wpmu_user_admin_message' ] ) && ! empty( $_POST[ 'b3_new_wpmu_user_admin_message' ] ) ) {
                        update_option( 'b3_new_wpmu_user_admin_message', htmlspecialchars( $_POST[ 'b3_new_wpmu_user_admin_message' ] ) );
                    } else {
        ...
        if ( 'POST' == $_SERVER[ 'REQUEST_METHOD' ] && isset( $_POST[ 'b3_users_nonce' ] ) ) {
            ...
            if ( ! wp_verify_nonce( $_POST[ 'b3_users_nonce' ], 'b3-users-nonce' ) ) {
                ...
                if ( isset( $_POST[ 'b3_activate_frontend_approval' ] ) && 1 == $_POST[ 'b3_activate_frontend_approval' ] ) {
                    update_option( 'b3_front_end_approval', 1 );
                } else {
