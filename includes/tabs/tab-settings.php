            ...
            <?php if ( is_main_site() ) { ?>
                ...
                <?php b3_get_settings_field_open(); ?>
                    ...
                    <div class="b3_settings-input b3_settings-input--checkbox">
                        ...
                        <?php echo sprintf( '%s to see what it does exactly.', sprintf( '<a href="%s">%s</a>', esc_url( B3_PLUGIN_SITE . '/faq/reset-default-settings/' ), esc_html__( 'Click here', 'b3-onboarding' ) ) ); ?>
                    </div>
                <?php b3_get_close(); ?>
