...
<div class="b3_form-element b3_form-element--first-name">
    ...
    <input class="input regular-text" id="first_name" name="first_name" type="text" value="<?php esc_attr_e( $current_user->first_name ); ?>"<?php echo $required; ?> />
</div>
...
<div class="b3_form-element b3_form-element--last-name">
    ...
    <input class="input regular-text" id="last_name" name="last_name" type="text" value="<?php esc_attr_e( $current_user->last_name ); ?>"<?php echo $required; ?> />
</div>
