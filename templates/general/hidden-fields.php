<?php
    ...
    $hidden_field_values = apply_filters( 'b3_hidden_fields', [], $attributes[ 'template' ] );
    ...
    if ( 'login' == $attributes[ 'template' ] && isset( $attributes[ 'redirect' ] ) ) {
        echo sprintf( '<input type="hidden" name="redirect_to" value="%s">', esc_attr( $attributes[ 'redirect' ] ) ) . "\n";
    }
